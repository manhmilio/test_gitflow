"""
Crawl dữ liệu 30 mã cổ phiếu Việt Nam trong 3 năm bằng vnstock.
...
# 3 năm theo yêu cầu cũ: 20/05/2023 -> 20/05/2026
...
OUTPUT_CSV = "vnstock_top30_monthly_2023_2026.csv"
OUTPUT_XLSX = "vnstock_top30_monthly_2023_2026.xlsx"
...
def main() -> None:
    print("=" * 80)
    print("CRAWL VNSTOCK MONTHLY DATA: TOP 30, 3 YEARS, SHARES OUTSTANDING")
    print("=" * 80)
